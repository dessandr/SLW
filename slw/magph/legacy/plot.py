"""Retained plot.in-driven plotting entrypoint for SLW post-processing."""
...
from slw.magph.legacy.plotting.registry import dispatch_plot, available_kinds
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m slw.magph.legacy.plot",
