...
from slw.exchange.legacy.build_spinor_soc_hr import _basis_permutation_from_win
from slw.exchange.legacy.reference.compute_J_epr_kspace import _compute_j_direct, _find_nearest_neighbours_from_epr
