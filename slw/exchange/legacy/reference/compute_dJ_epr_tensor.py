...
from slw.exchange.legacy.eph_epr_wrapper import _read_meta, _unit_scale_to_ev
from slw.exchange.legacy.reference.compute_J_epr_kspace import (
    _mirror_indices,
    _orbit_label_map,
    _split_chunks,
)
from slw.exchange.legacy.reference.compute_J_epr_tensor import _apply_model_soc
...
from slw.exchange.legacy.reference.compute_J_wannier_tensor import (
...
def _save_results(args, results, pair_meta, labels, tensor_axes, disp_axes, qmesh, *, complete=True):
    ...
    from slw.exchange.legacy.reference.compute_dJ_epr_kspace import _rp_grid
