...
from slw.exchange.legacy.adapt_gkq_h5_to_real_pkl import _load_single_gkq
...
class LKAGSolver:
    ...
    def compute_J_tensor_bulk(
        ...
        if tb2j_debug_pairing:
            self.last_tb2j_pairing_trace = {
                "n_pairs_req": int(len(req_idx_pairs)),
                "n_pairs_acc": int(len(acc_idx_pairs)),
                "n_R_req": int(len(req_R_list)),
                "n_R_acc": int(len(acc_R_list)),
    ...
    def load_g_real_epr_native(
        ...
        *,
        ...
        from slw.exchange.legacy.eph_epr_wrapper import EPRNativeProvider
    ...
    def compute_dJ_batch(
        ...
        if debug:
            debug_trace = {
                ...
                "n_pairs": int(len(idx_pairs)),
                "n_R": int(len(R_list)),
                "n_targets": int(len(atom_targets)),
                "axes": list(axes),
                "target_ctx": [],
                "energy_samples": [],
            }
