...
from slw.exchange.legacy.plot_epr_soc_bands import _clean_species, _match_u_to_kpath, _read_u_matrix, _spinor_u, _win_projection_groups
from slw.exchange.legacy.spinor_model import WANNIER90_D_ORDER, WANNIER90_P_ORDER, atomic_d_soc_block, atomic_p_soc_block
