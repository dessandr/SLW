"""EPR Hamiltonian, geometry, and diagnostic helpers for native exchange.
...
from slw.exchange.kernels.green import green_subblock_from_coefficients
...
_unit_scale_to_ev = energy_scale_to_ev
