"""Downfolded ligand-SOC helpers used by native tensor exchange.
...
from slw.exchange.kernels.epr import _build_hk_from_epr, _full_k_mesh
...
def build_downfolded_static_soc(args):
    ...
    hk_up, hk_dn, _hr_maps = _load_collinear_hk(args, kpts)
