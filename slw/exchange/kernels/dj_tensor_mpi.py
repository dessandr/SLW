"""MPI execution driver for the native tensor exchange-derivative kernel.
...
from slw.exchange.kernels.lkag import get_cfr_pole_mesh, get_semicircle_contour
from slw.exchange.kernels.spinor import spinor_from_collinear
